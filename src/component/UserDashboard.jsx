...
class HomePage extends Component {
    ...
    getSearchText = (text) => {
        if (text.trim().length === 0) {
            ...
            this.setState({
                searchText: text,
                myFlag: true,
                selectBoxValue:this.state.selectBoxValue="none"? "NEWEST_ARRIVAL":this.state.selectBoxValue
            }, () => this.searchAndFilter())
        }
    }
    ...
    render() {
        ...
        return (
            <div>
                <Header userData={this.state.userData} ref={this.searchBar} test={this.getSearchText} name={this.state.name}/>
