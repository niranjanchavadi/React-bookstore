...
class AdminPage extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            quantity: "", bookPrice: "",imageUrl: "",imageName:"Select Book Image",
            book: " ", author: " ",  descriptionOne: " ",
            year: " ", quantity1: " ", price: " ", err: "", abc: "", flag: false,
            snackFlag: false, snackMessage: "", bookError: "", authorError:"", descriptionError:"",
                                    ...
                                    <div id="formContent">
                                        ...
                                        <div className="description">
                                            <CustomTextFields
                                                ...
                                                multiline rows={2} fullWidth inputProps={{maxLength: 200}}
                                        ...
                                        <div className="input1">
                                            <label htmlFor="icon-button-file">
                                                <IconButton color="#A03037" aria-label="upload picture" component="span">
                                                    <AddPhotoAlternateIcon style={{fontSize:"180%"}}/> </IconButton> </label>
                                            <input
                                                type="file"
                                                required={true}
                                                name="imageUrl"
                                        ...
                                        <div className="btn">
                                            <Button variant="contained"
                                                    ...
                                                    // startIcon={<SaveIcon/>}
                                            > Save </Button>
                                            <Button variant="contained" style={{backgroundColor: "#A03037", color: "white"}}
                                                    size="large" className="button"
