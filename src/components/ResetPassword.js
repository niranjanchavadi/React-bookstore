        ...
        <CardContent>
          ...
          <div className="middle">
            ...
            <div className="passwordtext">
              <TextField required margin="dense"  color ="secondary" label="New Password"  size="small"  name="password"  variant="outlined"
            ...
            <div className="confirmpasswordtext">
                <TextField required  margin="dense" color="secondary" size="small" name="confirmPassword" variant="outlined"
